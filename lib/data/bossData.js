...
export const bossData = [
  ...
  {
    id: 'belurat-tower-settlement-boss',
    name: 'Belurat Tower Settlement Boss',
    title: 'Guardian of Belurat',
    difficulty: 'Advanced',
    ...
    phases: [
      {
        ...
        healthThreshold: 100,
        attacks: [
          'Shadow magic attacks',
          'Tower-based combat',
          'Defensive maneuvers',
          'Complex patterns'
        ],
        strategies: [
          'Learn the tower environment',
        ...
        tips: [
          'The tower environment affects the fight',
          'Watch for shadow magic attacks',
          'Use the space to your advantage',
          'Don\'t get cornered in the tower',
    ...
    rewards: [
      {
        type: 'item',
        name: 'Belurat Tower Key',
        description: 'Access to deeper areas of the tower'
      },
      {
        type: 'item',
    ...
    summonOptions: ['Spirit Ashes'],
    cheeseStrategies: [
      'Use the tower environment to your advantage',
      'Stay mobile and avoid corners',
      'Use ranged attacks when possible'
    ],
    requiredLevel: 90,
    tags: ['boss', 'shadow-erdtree', 'dlc', 'belurat', 'tower', 'shadow-magic']
  },

  {
    id: 'castle-ensis-boss',
    name: 'Castle Ensis Boss',
    title: 'Lord of Castle Ensis',
    difficulty: 'Advanced',
    ...
    phases: [
      {
        ...
        strategies: [
          'Use the castle environment',
          'Watch for shadow magic',
          'Stay mobile in the castle',
          'Use holy damage when possible',
          'Don\'t get trapped in corners'
        ],
        tips: [
          'The castle environment is key to the fight',
          'Use holy damage for best results',
          'Stay mobile and use the space',
          'Watch for shadow magic attacks',
          'Don\'t get cornered in the castle'
        ]
      },
      {
        phase: 2,
        ...
        strategies: [
          ...
          'Use the castle environment effectively'
        ],
        tips: [
    ...
    rewards: [
      {
        type: 'item',
        name: 'Castle Ensis Key',
        description: 'Access to deeper areas of Castle Ensis'
      },
      {
        type: 'item',
    ...
    requiredLevel: 95,
    tags: ['boss', 'shadow-erdtree', 'dlc', 'castle-ensis', 'shadow-lord', 'castle']
  },

  {
    id: 'scadu-altus-boss',
    name: 'Scadu Altus Boss',
    title: 'Guardian of Scadu Altus',
    difficulty: 'Expert',
    ...
    phases: [
      {
        ...
        attacks: [
          'Scadu Altus magic',
          'Plateau-based combat',
          'Complex patterns',
          'Defensive strategies'
        ],
        strategies: [
          'Learn Scadu Altus mechanics',
          'Use the plateau environment',
          'Stay mobile and patient',
          'Use physical damage when possible',
          'Watch for Scadu Altus magic'
        ],
        tips: [
          'Scadu Altus has unique mechanics',
          'Use the plateau space effectively',
          'Stay mobile and patient',
          'Physical damage is most effective',
          'Learn the Scadu Altus patterns'
        ]
      },
      {
        phase: 2,
        healthThreshold: 0,
        attacks: [
          'Enhanced Scadu Altus magic',
          'More aggressive plateau combat',
          'Complex patterns',
          'Defensive maneuvers'
        ],
        strategies: [
          'Maintain your strategy from phase 1',
          'Watch for enhanced Scadu Altus magic',
          'Stay mobile and patient',
          'Use physical damage consistently',
          'Don\'t panic during phase transitions'
        ],
        tips: [
          'Phase 2 enhances the Scadu Altus mechanics',
          'Maintain your strategy from phase 1',
          'Stay mobile and patient',
          'Use physical damage consistently',
          'Don\'t panic during phase transitions'
    ...
    rewards: [
      {
        type: 'item',
        name: 'Scadu Altus Key',
        description: 'Access to deeper areas of Scadu Altus'
      },
      {
        type: 'item',
    ...
    requiredLevel: 100,
    tags: ['boss', 'shadow-erdtree', 'dlc', 'scadu-altus', 'plateau', 'shadow-magic']
  },

  {
    id: 'shadow-keep-boss',
    name: 'Shadow Keep Boss',
    title: 'Guardian of the Shadow Keep',
    difficulty: 'Expert',
    location: 'Shadow Keep',
    level: '105-115',
    type: 'Shadow Boss',
    ...
    phases: [
      {
        ...
        strategies: [
          'Learn the Shadow Keep environment',
          'Use holy damage when possible',
        ...
        tips: [
          'The Shadow Keep environment is crucial',
          'Use holy damage for best results',
          'Stay mobile and use the space',
          'Watch for shadow magic attacks',
      ...
      },
      {
        ...
        healthThreshold: 0,
        attacks: [
          'Enhanced Shadow Keep magic',
          'More aggressive keep combat',
          'Complex patterns',
          'Defensive maneuvers'
        ],
        strategies: [
    ...
    rewards: [
      {
        ...
        description: 'Access to the deepest areas of Shadow Keep'
      },
      {
        type: 'item',
    ...
    requiredLevel: 105,
    tags: ['boss', 'shadow-erdtree', 'dlc', 'shadow-keep', 'keep', 'shadow-magic']
  },

  {
    id: 'final-shadow-boss',
    name: 'Final Shadow Boss',
    title: 'Ultimate Shadow Guardian',
    difficulty: 'Expert',
    ...
    phases: [
      {
        ...
        healthThreshold: 50,
        attacks: [
          'Ultimate shadow magic',
          'Realm-based combat',
          'Complex patterns',
          'Defensive strategies'
        ],
        strategies: [
          'Learn the Shadow Realm mechanics',
          'Use holy damage when possible',
          'Stay mobile in the realm',
          'Watch for ultimate shadow magic',
          'Don\'t get trapped in the realm'
        ],
        tips: [
          'The Shadow Realm has unique mechanics',
          'Use holy damage for best results',
          'Stay mobile and use the space',
          'Watch for ultimate shadow magic',
      ...
      },
      {
        ...
        healthThreshold: 0,
        attacks: [
          'Enhanced ultimate shadow magic',
          'More aggressive realm combat',
          'Complex patterns',
          'Defensive maneuvers'
        ],
        strategies: [
    ...
    rewards: [
      {
        type: 'item',
        name: 'Shadow Realm Key',
        description: 'Access to the deepest secrets of the Shadow Realm'
      },
      {
        type: 'item',
    ...
    requiredLevel: 110,
    tags: ['boss', 'shadow-erdtree', 'dlc', 'final-shadow', 'realm', 'ultimate']
  }
];
